...
UBTNode::UBTNode()
{
	...
	bIsInstanced = false;
	bIsInjected = false;
	NodeType = (uint32)BTNodeTypes_Node;
// 
...
uint32 UBTNode::sNodeTypeFlag = (uint32)BTNodeTypes_Node;
...
FString UBTNode::GetDescription() const
{
	return NodeName;
}
...
{
	return 0;// bCreateNodeInstance ? sizeof(FBTInstancedNodeMemory) : 0;
}

const UBTNode* UBTNode::GetNodeInstance(const UBehaviorTreeComponent& OwnerComp, uint8* NodeMemory) const
{
...
const UBTNode* UBTNode::GetNodeInstance(FBehaviorTreeSearchData& SearchData) const
{
...
UBTNode* UBTNode::GetNodeInstance(const UBehaviorTreeComponent& OwnerComp, uint8* NodeMemory)
{
	return this;
}


UBTNode* UBTNode::GetNodeInstance(FBehaviorTreeSearchData& SearchData)
{
	return this;
}
...
{
	//return NodeName.length() ? NodeName : UBehaviorTreeTypes::GetShortTypeName(this);
	return NodeName;
}
// 
...
// void UBTNode::DescribeRuntimeValues(const UBehaviorTreeComponent& OwnerComp, uint8* NodeMemory, EBTDescriptionVerbosity::Type Verbosity, std::vector<FString>& Values) const
// {
...
// FString UBTNode::GetXmlTypeName() const
// {
// 	return GetClass()->GetName();
// }
// //
// FXmlNode* UBTNode::ExportXml(class FXmlNode* ParentNode, class FXmlNode* TypesNode, TSet<UBehaviorTree*>& SubTrees) const
// {
// 	FXmlNode* Node = BTXmlUtils::NewXmlNode(ParentNode, GetXmlTagName());
// 
// 	Node->AppendAttribute(TEXT("Type"), GetXmlTypeName());
// 	Node->AppendAttribute(TEXT("Name"), NodeName);
// 
// 	return Node;
// }
// #endif // endif
